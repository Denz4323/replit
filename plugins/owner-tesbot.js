...
`
    ...
    return conn.sendButton(m.chat, hiasan, sewa, await (await fetch(`https://telegra.ph/file/789505b532837495ced55.jpg`)).buffer(), [["MENU", usedPrefix + "menu"], ["DONASI", usedPrefix + "donasi"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: '',
                        mediaType: 2,
