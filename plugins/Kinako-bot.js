...
let handler = async (m, { conn, command, text }) => {
  ...
  let pp = await conn.profilePictureUrl(who, 'image').catch((_) => "https://telegra.ph/file/789505b532837495ced55.jpg")
...
handler.customPrefix = /^(Hallo|halo|Halo|hallo|hi|helo|hai|hi|Hai|Helo|Hello|Bot|bot|denn|kp)$/i
